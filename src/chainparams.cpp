...
static  const  int64_t nGenesisSubsidy =0;
unsigned int pnSeed[] =
{
...
public:
    CMainParams() {
        ...
        // a large 4-byte int at any alignment.
		 ...
		 vAlertPubKey = ParseHex("044433d387cc85fcde2773879b81b19f7c2381465448721744141cca306ed576226f6fe9562ebb6bdc1f2e2a4b3f13b7188d3e45dea15fb6c2bf4f662e087b9995 ");        
		 nDefaultPort = 6666;        
		 nRPCPort = 6667;        
		 bnProofOfWorkLimit = CBigNum(~uint256(0) >> 16);        
		 nSubsidyHalvingInterval = 50000;

		//unsigned int tt = Params().ProofOfWorkLimit().GetCompact();
		...
		const char* pszTimestamp = "The Times 07/June/2017";       
		CTransaction txNew;        
		txNew.vin.resize(1);        
		txNew.vout.resize(1);        
		...
		txNew.vout[0].scriptPubKey = CScript() << ParseHex("044433d387cc85fcde2773879b81b19f7c2381465448721744141cca306ed576226f6fe9562ebb6bdc1f2e2a4b3f13b7188d3e45dea15fb6c2bf4f662e087b9995 ") << OP_CHECKSIG;        
		genesis.vtx.push_back(txNew);        
		genesis.hashPrevBlock = 0;        
		genesis.hashMerkleRoot = genesis.BuildMerkleTree();        
		genesis.nVersion = 1;        
		genesis.nTime    = 1499397318;        
		genesis.nBits    = 0x1F00FFFF;        
		genesis.nNonce   = 362677172;        
	...
	//	printf("<<<<<<<<<<hashGenesisBlock  = %s \n",hashGenesisBlock.GetHex().c_str());
		...
		*/
		...
		base58Prefixes[PUBKEY_ADDRESS] = list_of(0);       //list_of(75);//x 
		base58Prefixes[SCRIPT_ADDRESS] = list_of(5);        //list_of(25);//b
		base58Prefixes[SECRET_KEY] =     list_of(128);        // list_of(40);//h
...
public:
    CTestNetParams() {
      ...
      //  vFixedSeeds.clear();
      //  vSeeds.clear();
     //   vSeeds.push_back(CDNSSeedData("xbhcoin.petertodd.org", "testnet-seed.xbhcoin.petertodd.org"));
...
public:
    CRegTestParams() {
        ...
        genesis.nTime = 1499397318;
        genesis.nBits = 0x1F00FFFF;//0x207fffff;
        genesis.nNonce = 362677172;
        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 18444;
        strDataDir = "regtest";
