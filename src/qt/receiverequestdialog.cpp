...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatxbhcoinURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + xbhcoinUnits::formatWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatxbhcoinURI(info));
}
